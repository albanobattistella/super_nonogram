...
# e.g. [download_windows]: https://github.com/adil192/super_nonogram/releases/download/v0.11.0/SuperNonogramInstaller_v0.11.0.exe
sed -i "s|\[download_windows\]: .*|\[download_windows\]: https://github.com/adil192/super_nonogram/releases/download/v${BUILD_NAME}/SuperNonogramInstaller_v${BUILD_NAME}.exe|g" README.md

echo " - Updating AppImage download link in README.md"
# e.g. [download_appimage]: https://github.com/adil192/super_nonogram/releases/download/v0.11.0/SuperNonogram-0.11.0-x86_64.AppImage
sed -i "s|\[download_appimage\]: .*|\[download_appimage\]: https://github.com/adil192/super_nonogram/releases/download/v${BUILD_NAME}/SuperNonogram-${BUILD_NAME}-x86_64.AppImage|g" README.md
...
FLATPAK_FILE="flatpak/com.adilhanney.super_nonogram.metainfo.xml"
...
"""
  awk -v release="$RELEASE_TAG" 'NR==90{print release}1' "$FLATPAK_FILE" > "${FLATPAK_FILE}.tmp"
...
if [ "$EDITOR" != "" ]; then
  ...
  "$EDITOR" flatpak/com.adilhanney.super_nonogram.metainfo.xml
fi
